...
if __name__ == '__main__':
    file = "/Users/liqi/Desktop/文档/翻译文档.xlsx"
    eh = ExcelHandle(file, "iOS翻译文档")
    data = eh.get_data_dict(624)  # list类型
    #print(data)
    with open("/Users/liqi/Documents/移动端项目代码/TronLink_iOS/TronLink/Supporting Files/en.lproj/Localizable.strings", 'r') as f:
      ff = f.read()
      str = handleString(ff);
      #print(str)
      load_dict_en = json.loads(str)

    print(load_dict_en)


    with open("/Users/liqi/Documents/移动端项目代码/TronLink_iOS/TronLink/Supporting Files/zh-Hans.lproj/Localizable.strings", 'r') as f:
        ff = f.read()
        str = handleString(ff);
        print(str)
        load_dict_zh = e(str)
